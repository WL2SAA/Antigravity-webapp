import{A as e,C as t,D as n,E as r,O as i,S as a,T as o,_ as s,a as c,b as l,c as u,d,f,h as p,i as m,k as h,l as g,m as _,n as v,o as y,p as b,r as x,s as S,t as C,u as w,v as T,w as E,x as D,y as O}from"./Mouse.D0_DmmWM.js";import{t as k}from"./gsap.DWxn8li7.js";var A=e(x(),1),j=(e,t,n,r,i)=>(e-t)*(i-r)/(n-t)+r,M=class e{constructor(e,t){this.scene=e,this.renderer=e.renderer,this.gl=this.gl,this.camera=e.camera,this.textures=t,this.lastTime=0,this.everRendered=!1,this.mousePos=new n(0,0),this.cursorPos=new n(0,0),this.colorScheme=e.theme===`dark`?0:1,this.particleScale=this.scene.renderer.domElement.width/this.scene.pixelRatio/2e3*this.scene.particlesScale}static async create(t,n){let r=new e(t,n);return r.createPoints(),await r.createPointsFromImage(),r.init(),r}async getImageData(e){return new Promise((t,n)=>{let r=new Image;r.src=e,r.onload=()=>{let e=document.createElement(`canvas`);e.width=500,e.height=500;let n=e.getContext(`2d`);n.drawImage(r,0,0,500,500),t(n.getImageData(0,0,500,500))},r.onerror=n})}createPoints(){let e=new A.default({shape:[500,500],minDistance:j(this.scene.density,0,300,10,2),maxDistance:j(this.scene.density,0,300,11,3),tries:20}).fill();this.pointsBaseData=e,this.pointsData=[];for(let t=0;t<e.length;t++)this.pointsData.push(e[t][0]-250,e[t][1]-250);this.count=this.pointsData.length/2}async createPointsFromImage(){let e=[];for(let t=0;t<this.textures.length;t++){let n=await this.getImageData(this.textures[t]);e.push(n)}this.nearestPointsData=[];let t=[];for(let n=0;n<this.textures.length;n++)t.push(this.createPointsDistanceDataWorker(e[n],this.pointsBaseData,n));let n=await Promise.all(t);n.sort((e,t)=>e.index-t.index),n.forEach(e=>{this.nearestPointsData.push(e.nearestPoints)})}createPointsDistanceDataWorker(e,t,n){return new Promise((r,i)=>{let a=new Blob([`
            ...
            `],{type:`application/javascript`}),o=URL.createObjectURL(a),s=new Worker(o);s.onmessage=function(e){let{nearestPoints:t,index:n}=e.data;s.terminate(),URL.revokeObjectURL(o),r({nearestPoints:t,index:n})},s.onerror=function(e){console.error(`Worker error:`,e),s.terminate(),URL.revokeObjectURL(o),i(e)},s.postMessage({imageData:e,pointsBase:t,index:n,density:this.scene.density})})}createDataTexturePosition(e){let t=new Float32Array(this.length*4);for(let n=0;n<this.count;n++){let r=n*4;t[r+0]=e[n*2+0]*(1/250),t[r+1]=e[n*2+1]*(1/250),t[r+2]=0,t[r+3]=0}let n=new f(t,this.size,this.size,a,b);return n.needsUpdate=!0,n}createRenderTarget(){return new h(this.size,this.size,{wrapS:E,wrapT:E,minFilter:s,magFilter:s,texture:this.posTex,format:a,type:_,depthBuffer:!1,stencilBuffer:!1})}setPointsTextureFromIndex(e){this.posNearestTex=this.createDataTexturePosition(this.nearestPointsData[e]),this.posNearestTex.needsUpdate=!0,this.simMaterial.uniforms.uPosNearest=this.posNearestTex}init(){this.size=256,this.length=this.size*this.size,this.posTex=this.createDataTexturePosition(this.pointsData),this.posNearestTex=this.createDataTexturePosition(this.nearestPointsData[0]),this.rt1=this.createRenderTarget(),this.rt2=this.createRenderTarget(),this.renderer.setRenderTarget(this.rt1),this.renderer.setClearColor(0,0),this.renderer.clear(),this.renderer.setRenderTarget(this.rt2),this.renderer.setClearColor(0,0),this.renderer.clear(),this.renderer.setRenderTarget(null),this.noise=new v,this.simScene=new o,this.simCamera=new T(-1,1,1,-1,0,1),this.simMaterial=new r({uniforms:{uPosition:{value:this.posTex},uPosRefs:{value:this.posTex},uPosNearest:{value:this.posNearestTex},uMousePos:{value:new n(0,0)},uRingRadius:{value:.2},uDeltaTime:{value:0},uRingWidth:{value:.05},uRingWidth2:{value:.015},uIsHovering:{value:0},uRingDisplacement:{value:this.scene.ringDisplacement},uTime:{value:0}},vertexShader:`
                void main() {
            ...
            `});let e=new p(new l(2,2),this.simMaterial);this.simScene.add(e);let t=new u,i=new Float32Array(this.count*2),a=new Float32Array(this.count*3),s=new Float32Array(this.count*4);for(let e=0;e<this.count;e++){let t=e%this.size,n=Math.floor(e/this.size);i[e*2]=t/this.size,i[e*2+1]=n/this.size}for(let e=0;e<this.count;e++)s[e*4]=Math.random(),s[e*4+1]=Math.random(),s[e*4+2]=Math.random(),s[e*4+3]=Math.random();t.setAttribute(`position`,new S(a,3)),t.setAttribute(`uv`,new S(i,2)),t.setAttribute(`seeds`,new S(s,4)),this.renderMaterial=new r({uniforms:{uPosition:{value:this.posTex},uTime:{value:0},uColor1:{value:new w(this.scene.colorControls.color1)},uColor2:{value:new w(this.scene.colorControls.color2)},uColor3:{value:new w(this.scene.colorControls.color3)},uAlpha:{value:1},uIsHovering:{value:0},uPulseProgress:{value:0},uMousePos:{value:new n(0,0)},uRez:{value:new n(this.scene.renderer.domElement.width,this.scene.renderer.domElement.height)},uParticleScale:{value:this.particleScale},uPixelRatio:{value:this.scene.pixelRatio},uColorScheme:{value:this.colorScheme}},vertexShader:`
                precision highp float;
            ...
            `,transparent:!0,depthTest:!1,depthWrite:!1}),this.mesh=new D(t,this.renderMaterial),this.mesh.position.set(0,0,0),this.mesh.scale.set(5,-5,5),this.scene.scene.add(this.mesh)}resize(){this.renderMaterial.uniforms.uRez.value=new n(this.scene.renderer.domElement.width,this.scene.renderer.domElement.height),this.renderMaterial.uniforms.uPixelRatio.value=this.scene.pixelRatio,this.renderMaterial.needsUpdate=!0}update(){let e=this.scene.clock.getElapsedTime()-this.lastTime;this.lastTime=this.scene.clock.getElapsedTime(),this.scene.isIntersecting,this.mousePos.set(this.scene.intersectionPoint.x*.175,this.scene.intersectionPoint.y*.175),this.particleScale=this.scene.renderer.domElement.width/this.scene.pixelRatio/2e3*this.scene.particlesScale,this.simMaterial.uniforms.uPosition.value=this.everRendered?this.rt1.texture:this.posTex,this.simMaterial.uniforms.uTime.value=this.scene.clock.getElapsedTime(),this.simMaterial.uniforms.uDeltaTime.value=e,this.simMaterial.uniforms.uRingRadius.value=.175+Math.sin(this.scene.time*1)*.03+Math.cos(this.scene.time*3)*.02,this.simMaterial.uniforms.uMousePos.value=this.mousePos,this.simMaterial.uniforms.uRingWidth.value=this.scene.ringWidth,this.simMaterial.uniforms.uRingWidth2.value=this.scene.ringWidth2,this.simMaterial.uniforms.uRingDisplacement.value=this.scene.ringDisplacement,this.simMaterial.uniforms.uIsHovering.value=this.scene.hoverProgress,this.simMaterial.uniforms.uPosNearest.value=this.posNearestTex,this.renderer.setRenderTarget(this.rt2),this.renderer.render(this.simScene,this.simCamera),this.renderer.setRenderTarget(null),this.renderMaterial.uniforms.uPosition.value=this.everRendered?this.rt2.texture:this.posTex,this.renderMaterial.uniforms.uTime.value=this.scene.clock.getElapsedTime(),this.renderMaterial.uniforms.uMousePos.value=this.mousePos,this.renderMaterial.uniforms.uParticleScale.value=this.particleScale,this.renderMaterial.uniforms.uIsHovering.value=this.scene.hoverProgress,this.renderMaterial.uniforms.uPulseProgress.value=this.scene.pushProgress}postRender(){let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.everRendered=!0}kill(){this.mesh.geometry.dispose(),this.mesh.material.dispose(),this.rt1.dispose(),this.rt2.dispose(),this.posTex.dispose(),this.simMaterial.dispose(),this.renderMaterial.dispose()}},N=class{constructor(e){this.loaded=!1,this.textures=e.textures||[`/assets/textures/icons/icon_cube.png`],this.color1=e.color1||`#aecbfa`,this.color2=e.color2||`#aecbfa`,this.color3=e.color3||`#93bbfc`,this.options=e,this.theme=e.theme||`dark`,this.interactive=!1,this.options.background=this.theme===`dark`?new w(1184535):new w(16777215),this.pixelRatio=e.pixelRatio||window.devicePixelRatio,this.particlesScale=e.particlesScale||.5,this.density=e.density||150,this.cameraZoom=e.cameraZoom||3.5,this.verbose=e.verbose||!1,this.onLoadedCallback=e.onLoaded||null,this.isHovering=!1,this.hoverProgress=0,this.pushProgress=0,this.scene=new o,this.scene.background=this.options.background,this.canvas=document.createElement(`canvas`),this.options.container.appendChild(this.canvas),this.canvas.width=this.options.container.offsetWidth,this.canvas.height=this.options.container.offsetHeight,d.enabled=!1,this.renderer=new y({canvas:this.canvas,antialias:!0,alpha:!0,powerPreference:`high-performance`,preserveDrawingBuffer:!0,stencil:!1,precision:`highp`}),this.gl=this.renderer.getContext(),this.renderer.extensions.get(`EXT_color_buffer_float`),this.renderer.setSize(this.canvas.width,this.canvas.height),this.renderer.setPixelRatio(this.pixelRatio),this.onWindowResize=this.onWindowResize.bind(this),this.initCamera(),this.initScene(),this.initEvents(),this.clock=new g,this.time=0,this.lastTime=0,this.dt=0,this.skipFrame=!1,this.isPaused=!1,this.raycaster=new t,this.mouse=new n,this.intersectionPoint=new i,this.isIntersecting=!1,this.mouseIsOver=!1}initEvents(){window.addEventListener(`resize`,e=>{this.onWindowResize()})}onWindowResize(){this.canvas.width=this.options.container.offsetWidth,this.canvas.height=this.options.container.offsetHeight,this.renderer.setSize(this.canvas.width,this.canvas.height),this.camera.aspect=this.canvas.width/this.canvas.height,this.camera.updateProjectionMatrix(),this.particles&&this.particles.resize()}onHoverStart(){k.to(this,{hoverProgress:1,duration:.5,ease:`power3.out`}),k.fromTo(this,{pushProgress:0},{pushProgress:1,duration:2,delay:.1,ease:`power2.out`})}onHoverEnd(){k.to(this,{hoverProgress:0,duration:.5,ease:`power3.out`}),k.fromTo(this,{pushProgress:0},{pushProgress:1,duration:2,delay:0,ease:`power2.out`})}setPointsTextureFromIndex(e){k.delayedCall(.1,()=>{this.particles&&this.particles.setPointsTextureFromIndex(e)}),k.fromTo(this,{pushProgress:0},{pushProgress:1,duration:2,ease:`power2.out`})}initCamera(){this.camera=new O(40,this.gl.drawingBufferWidth/this.gl.drawingBufferHeight,.1,1e3),this.camera.position.z=this.cameraZoom}async initScene(){this.colorControls={color1:this.theme===`dark`?`#318bf7`:this.color1,color2:this.theme===`dark`?`#bada4c`:this.color2,color3:this.theme===`dark`?`#e35058`:this.color3},await this.initParticles(),this.options.gui&&this.initGUI(),this.onLoaded()}async initParticles(){this.particles=await M.create(this,this.textures)}initGUI(){this.gui=new c({autoPlace:!1}),this.options.container.appendChild(this.gui.domElement),this.gui.domElement.style.position=`absolute`,this.gui.domElement.style.top=`0`,this.gui.domElement.style.right=`0`,this.gui.domElement.style.zIndex=`1000`;let e=this.gui.addFolder(`Colors`);e.addColor(this.colorControls,`color1`).name(`Color 1`).onChange(e=>{this.particles.renderMaterial.uniforms.uColor1.value.set(new w(e))}),e.addColor(this.colorControls,`color2`).name(`Color 2`).onChange(e=>{this.particles.renderMaterial.uniforms.uColor2.value.set(new w(e))}),e.addColor(this.colorControls,`color3`).name(`Color 3`).onChange(e=>{this.particles.renderMaterial.uniforms.uColor3.value.set(new w(e))}),e.add(this,`particlesScale`).name(`Particles Scale`).min(.1).max(4).step(.01).onChange(e=>{this.particlesScale=e}),e.add(this,`density`).name(`Density`).min(50).max(250).step(10).onChange(async e=>{this.density=e,this.verbose,this.killParticles(),await this.initParticles()}),e.open()}stop(){this.isPaused=!0,this.clock.stop(),this.verbose}resume(){this.isPaused=!1,this.clock.start(),this.verbose}killParticles(){this.scene.remove(this.particles.mesh),this.particles.kill()}kill(){this.stop(),window.removeEventListener(`resize`,this.onWindowResize),this.raycastPlane&&(this.scene.remove(this.raycastPlane),this.raycastPlane.geometry.dispose(),this.raycastPlane.material.dispose()),this.renderer&&this.renderer.dispose(),this.canvas&&this.canvas.parentElement&&this.canvas.parentElement.removeChild(this.canvas)}onLoaded(){this.loaded=!0,this.onLoadedCallback&&typeof this.onLoadedCallback==`function`&&this.onLoadedCallback(this)}preRender(){if(this.dt=this.clock.getElapsedTime()-this.lastTime,this.lastTime=this.clock.getElapsedTime(),this.time+=this.dt,this.particles.update(),this.interactive&&!this.skipFrame){let e=this.canvas.getBoundingClientRect();C.cursor,this.mouse.x=(C.cursor.x-e.left)*(C.screenWidth/e.width),this.mouse.y=(C.cursor.y-e.top)*(C.screenHeight/e.height),this.mouse.x=this.mouse.x/C.screenWidth*2-1,this.mouse.y=-(this.mouse.y/C.screenHeight)*2+1,this.mouseIsOver=!(this.mouse.x<-1||this.mouse.x>1||this.mouse.y<-1||this.mouse.y>1)}if(this.skipFrame=!this.skipFrame,!this.skipFrame&&this.raycastPlane){this.raycaster.setFromCamera(this.mouse,this.camera);let e=this.raycaster.intersectObject(this.raycastPlane);e.length>0&&this.mouseIsOver?(this.intersectionPoint.copy(e[0].point),this.isIntersecting=!0):this.isIntersecting=!1}}render(){!this.loaded||this.isPaused||(this.preRender(),this.renderer.setRenderTarget(null),this.renderer.autoClear=!1,this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.postRender())}postRender(){this.particles.postRender()}};document.addEventListener(`DOMContentLoaded`,()=>{document.querySelectorAll(`[data-morphing-particles-component]`).forEach(e=>{let t=e.querySelector(`[data-container]`);if(!t)return;let n=e.getAttribute(`data-theme`)||`dark`,r=parseInt(e.getAttribute(`data-density`)||`100`),i=new N({container:t,theme:n,particlesScale:parseFloat(e.getAttribute(`data-particles-scale`)||`1`),cameraZoom:parseFloat(e.getAttribute(`data-camera-zoom`)||`3.5`),density:r,textures:JSON.parse(e.getAttribute(`data-textures`)||`[]`),color1:e.getAttribute(`data-color1`)||void 0,color2:e.getAttribute(`data-color2`)||void 0,color3:e.getAttribute(`data-color3`)||void 0,interactive:!0,gui:new URLSearchParams(window.location.search).get(`gui`)===`true`,verbose:!1,onLoaded:()=>{e.dispatchEvent(new CustomEvent(`loaded`))}}),a=!1,o=null,s=new IntersectionObserver(e=>{e.forEach(e=>{a=e.isIntersecting,e.isIntersecting?i.resume():i.stop()})},{root:null,rootMargin:`0px`,threshold:0});s.observe(t);let c=()=>{o=requestAnimationFrame(c),a&&i.render()};c(),e.helper={onHover:()=>i.onHoverStart(),onLeave:()=>i.onHoverEnd(),setPointsTextureFromIndex:e=>i.setPointsTextureFromIndex(e),kill:()=>i.kill()},window.addEventListener(`beforeunload`,()=>{s.disconnect(),o!==null&&cancelAnimationFrame(o),i.kill()})})});